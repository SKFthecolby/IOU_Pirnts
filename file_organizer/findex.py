...
from file_organizer.database import connect
from file_organizer.drive_discovery import list_windows_drives, select_roots
from file_organizer.scanner import scan_paths
from file_organizer.search import text_search, by_ext, by_category
from file_organizer.reports import generate_reports
from file_organizer.planner import build_plan
from file_organizer.mover import execute_move
from file_organizer.rollback import list_batches, run_rollback
from file_organizer.duplicate_detector import detect_duplicates
...
def main():
    ...
    if a.cmd == 'drives': print('\n'.join(list_windows_drives()))
        ...
        from file_organizer.tui import show_menu
